...
const raceData: AgeGroup[] = [
    {
        ...
        participants: [
            { name: "Tavi Borisova", results: [] },
            { name: "Tora Borisova", results: [] },
    ...
    },
    {
        ...
        participants: [
            ...
            { name: "Ellen Vore", results: parseResults("SE(1)") },
            ...
            { name: "Liz Paunicka", results: [] },
            { name: "Brenda Straka", results: [] },
            { name: "Paula Tankersley", results: [] },
    ...
    },
    {
        ...
        participants: [
            { name: "Krista Overstreet", results: parseResults("SE(2) CC10(2)") },
    ...
    },
    {
        ...
        participants: [
            { name: "Leslie Hammersmith", results: parseResults("CC5(2)") },
    ...
    },
    {
        ...
        participants: [
            ...
            { name: "Tina Ammermann", results: [] },
            { name: "Rebecca Dey", results: [] },
            { name: "Cathy Giffel", results: [] },
    ...
    },
    {
        ...
        ageRange: { min: 20, max: 29 },
        participants: [
            { name: "Brody Wilt", results: parseResults("CC10(2)") },
    ...
    },
    {
        ...
        participants: [
            ...
            { name: "Andrew Rehn", results: [] },
            { name: "Devin Rittenhouse", results: [] },
    ...
    },
    {
        ...
        participants: [
            ...
            { name: "Matthias Diener", results: parseResults("CC5(2)") },
            { name: "Stephen Johnson", results: parseResults("CC15(2)") },
            { name: "Patrick Garner", results: parseResults("CC15(1)") },
            { name: "Scott Tess", results: parseResults("SE(1)") },
            { name: "David Albouy", results: [] },
            { name: "Ramses Armendariz", results: [] },
            { name: "Eric Benson", results: [] },
            { name: "Nikita Borisov", results: [] },
            { name: "Joshua Brown", results: [] },
    ...
    },
    {
        ...
        ageRange: { min: 50, max: 59 },
        participants: [
            { name: "Michael Tankersley", results: parseResults("SE(4)") },
            { name: "Minh Do", results: parseResults("SE(3)") },
            { name: "David Ammermann", results: parseResults("SE(2)") },
            { name: "Scott Silverman", results: parseResults("CC10(2)") },
            { name: "Brad Giffel", results: parseResults("SE(1)") },
    ...
    },
    {
        ...
        ageRange: { min: 60, max: 69 },
        participants: [
            { name: "Don Dodson", results: parseResults("CC15(2)") },
            { name: "Richard Mann", results: parseResults("SE(2)") },
